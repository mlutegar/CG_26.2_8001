...
Execução: `python AC02_transformacoes_geometricas/transformacoes.py`.
...
![](../AC02_transformacoes_geometricas/saida/ex01_translacao.png)
...
![](../AC02_transformacoes_geometricas/saida/ex05_rotacao_quadrado.png)

### Exercício 6 — Reflexão no eixo y
`P(2,5)` → **P'(−2, 5)** (só o sinal de x muda).

![](../AC02_transformacoes_geometricas/saida/ex06_reflexao_ponto.png)

### Exercício 7 — Reflexão de triângulo no eixo x
`A(2,3) B(4,3) C(3,5)` → **A(2,−3) B(4,−3) C(3,−5)** (só o sinal de y muda).

![](../AC02_transformacoes_geometricas/saida/ex07_reflexao_triangulo.png)

### Exercício 8 — Cisalhamento horizontal (k = 2)
`P(2,3)`, `x' = x + k·y = 2 + 2·3` → **P'(8, 3)**.

![](../AC02_transformacoes_geometricas/saida/ex08_cisalhamento.png)
...
![](../AC02_transformacoes_geometricas/saida/ex09_composicao_ponto.png)
...
![](../AC02_transformacoes_geometricas/saida/ex10_composicao_retangulo.png)
